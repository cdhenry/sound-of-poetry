...
export default function ToggleInput(props: IToggleInputProps): JSX.Element {
    return (
        <label className="flex items-center relative w-max cursor-pointer select-none">
            ...
            <input
                type="checkbox"
                className="toggle-input appearance-none transition-colors cursor-pointer w-16 h-8 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-blue-500 bg-blue-500"
                value={props.value}
